...
pub enum IPPTag {
    ...
    Range,                                      // Range value
    #[doc(hidden)] BeginCollection,             // Beginning of collection value @exclude all@
    TextLang,                                   // Text-with-language value
    NameLang,                                   // Name-with-language value
    #[doc(hidden)] EndCollection,               // End of collection value @exclude all@
    Text = 0x41,                                // Text value
    Name,                                       // Name value
    #[doc(hidden)] ReservedString,              // Reserved for future string value @private@
    ...
    #[doc(hidden)] MemberName,                  // Collection member name value @exclude all@
    #[doc(hidden)] Extension = 0x7f,            // Extension point for 32-bit tags @exclude all@
    #[doc(hidden)] CupsMask = 0x7fffffff,       // Mask for copied attribute values @private@
    #[doc(hidden)] CupsConst = -0x7fffffff - 1, // Bitflag for copied/const attribute values @private@
}