...
pub enum IppStatus {
    ...
    #[doc(hidden)] OkTooManyEvents,               // successful-ok-too-many-events
    #[doc(hidden)] OkButCancelSubscription,       // successful-ok-but-cancel-subscription @private@
    OkEventsComplete,                             // successful-ok-events-complete
    #[doc(hidden)] RedirectionOtherSite = 0x0200, // redirection-other-site @private@
    #[doc(hidden)] CupsSeeOther = 0x0280,         // cups-see-other @private@
    ...
    #[doc(hidden)] ErrorIgnoredAllNotifications,  // client-error-ignored-all-notifications @private@
    #[doc(hidden)] ErrorPrintSupportFileNotFound, // client-error-print-support-file-not-found @private@
